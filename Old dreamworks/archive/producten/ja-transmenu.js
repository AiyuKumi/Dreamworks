...
TransMenu.Color = "#ffffff";
TransMenu.shadowPng = "img/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#006666";                   // color of the background (transparency set in CSS)
...
TransMenu.subpad_x = 2;								   // Horizontal Padding between top right corner of item menu and its submenu (level > 2)
...
function TransMenuItem(sText, sUrl, oParent, browserNav, active) {
        ...
        function toString(bDingbat) {
				...
				var id = active?' id="active" ':'';
					return '<tr class="item"'+id+'><td nowrap style="' + sPaddingLeft + sPaddingRight + '"><div style="color:#ffffff; background: url(' + sDingbat + ') right no-repeat;">' + 
                        sText + '</div></td></tr>';
