...
// ======================================================================================================================================
        ...
        ******************************************************************************/
        ...
        graphicsDir : 'Medias/Phototheque3/Graphics/',
...
// ======================================================================================================================================
        ...
        hs.graphicsDir = 'Medias/Phototheque3/Graphics/';
        hs.align = 'center';
...
// ======================================================================================================================================
		...
		function GetGallery(SiteId,Repertoires,Nombre,PageEnCours,Langue,Bords,Format,RepertoiresIni,Params,CleUnique,Gallery3Graphics,Gallery3Level) {
            var xhr_object = null;
			if(window.XMLHttpRequest) { xhr_object = new XMLHttpRequest(); }
			else if(window.ActiveXObject) { xhr_object = new ActiveXObject("Microsoft.XMLHTTP"); }
			else { alert("Votre navigateur ne supporte pas les objets XMLHTTPRequest...");return; }
			var method = "POST";
			var filename = "Medias/Phototheque3/Systems/Gallery3.asp";
			var SiteId = SiteId;
			var Repertoires = Repertoires;
			var Nombre = Nombre;
			var PageEnCours = PageEnCours;
			var Langue = Langue;
			var Bords = Bords;
			var Format = Format;
			var Parents = Parents;
			var RepertoiresIni = RepertoiresIni;
			var Params = Params;
			var CleUnique = CleUnique;
            var Gallery3Graphics = Gallery3Graphics;
			var data = encodeURI("SiteId="+SiteId+"&Repertoires="+Repertoires+"&Nombre="+Nombre+"&PageEnCours="+PageEnCours+"&Langue="+Langue+"&Bords="+Bords+"&Format="+Format+"&RepertoiresIni="+RepertoiresIni+"&Params="+Params+"&CleUnique="+CleUnique+"&Gallery3Graphics="+Gallery3Graphics+"&Gallery3Level="+Gallery3Level);
			xhr_object.open(method,filename,true);
			xhr_object.onreadystatechange = function() { if ( xhr_object.readyState == 4 ) {
				var tmp = xhr_object.responseText.split("$");
				if ( tmp[0] == "ok" ) {
					document.getElementById("Gallery3Content"+CleUnique).innerHTML = tmp[1];
                    if ( Params.indexOf("Fancybox") > -1 ) {
                        $(".iFrameBox").fancybox({
                            'frameWidth': 800,
                            'frameHeight': 470
                        });
